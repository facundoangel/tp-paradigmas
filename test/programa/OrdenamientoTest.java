...
public class OrdenamientoTest {
	/*
	 * En este test se prueba de que el programa ordene adecuadamente los datos
	 * que recibe por medio de los archivos de entrada.
	 * 
	 * Los datos en cuestion que se ordenan son las atracciones y las
	 * promociones, estas se ordenan en base a las preferencias de un
	 * determinado usuario.
	 * 
	 * La forma de ordenamiento es decreciente en función del tiempo y si este
	 * es el mismo, entonces se ordena de manera decreciente en función del
	 * costo
	 */
	...
	public void ordenamientoPrefAventura() {
		...
		/*
		 * En este test se prueba que se ordene correctamente los datos de
		 * entrada en función de un usuario que prefiera las atraciones del tipo
		 * aventura
		 */
