...
public abstract class Promocion extends Oferta {
	...
	// Vende todas sus atracciones y pone su disponibilidad en falso para que no
	// se sugiera la atraccion ni las promos con esa atraccion
	@Override
	public void vender() {
	...
	// Comprueba que todas sus atracciones están disponible si alguna no esta
	// disponible se setea a false la disponibilidad de la promo
	...
	// Si al resetear la disponibilidad de sus atracciones, esta queda en
	// falso(no tiene mas cupos), la promocion ya no esta disponible
	@Override
