...
public class ComparatorXPref implements Comparator<Oferta> {
	...
	// primero pregunta si alguno de los dos es de la preferencia del cliente
	// despues preguntamos si alguno de los dos es promo ya que van primero las
	// promos
	...
	public int compare(Oferta of1, Oferta of2) {
		...
		// si llega hasta aca, son dos ofertas con distinto tipo al de la
		// preferencia, con igual precio y tiempo
